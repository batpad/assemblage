...
fabric.pan_state = { ison: false, cursor: '' };
  ...
  var InteractiveMethods = /** @scope fabric.Canvas.prototype */ {
    ...
    __onMouseUp: function (e) {
      ...
      if (activeGroup) {
		...
		if(style)
		{
	        if(fabric.pan_state.ison)
				style.cursor = fabric.pan_state.cursor;
			else
	...
	if(fabric.pan_state.ison) //HACK NASTY!!
		this.upperCanvasEl.style.cursor = fabric.pan_state.cursor;
	...
	return ; // HACK: NASTY: NEVER PERMIT OVERRIDE THE DEFAULT CHANGE IN STATE FOR GROUPS
    ...
    */
    ...
    _setCursorFromEvent: function (e, target) {
	  ...
	  if(fabric.pan_state.ison)
	  {
		s.cursor = fabric.pan_state.cursor;
		return false;
	  }
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @scope fabric.Object.prototype */ {
    ...
    stateProperties:  (
      ...
      'borderScaleFactor transformMatrix selectable isJoinedObj'
    ).split(' '),
	...
	//Added by Shrikant from the Github link
	/**
